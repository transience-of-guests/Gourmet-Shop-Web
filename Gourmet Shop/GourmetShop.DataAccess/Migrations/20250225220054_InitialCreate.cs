    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__3214EC078BCE0C25", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AuthenticationId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Subcateg__3214EC07708EE32C", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Subcatego__Categ__4E88ABD4",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shopping__3214EC07CBA23AB8", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SHOPPING_CART_REFERENCE_USER",
                        column: x => x.UserId,
                        principalTable: "UserInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubcategoryId = table.Column<int>(type: "int", nullable: true, defaultValueSql: "(NULL)"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ORDERITEM_REFERENCE_ORDER",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ORDERITEM_REFERENCE_PRODUCT",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shopping__3214EC07B7666530", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SHOPPING_CART_DETAILS_REFERENCE_CART",
                        column: x => x.CartId,
                        principalTable: "ShoppingCart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SHOPPING_CART_DETAILS_REFERENCE_PRODUCT",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Categori__737584F65623B0CE",
                table: "Categories",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartDetails_CartId",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Subcateg__737584F65DD90A06",
                table: "Subcategories",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInfo_AuthenticationId",
                table: "UserInfo",
